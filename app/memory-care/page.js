                    ...
                    <div className="row">
                        <div className="col-lg-4 pe-lg-60">
                            <div className="category-widget">
                                ...
                                <ul className="category-widget-list">
                                    ...
                                    <li className="active"><Link href="/memory-care">Memory Care <i className="icon-40"></i></Link></li>
                                </ul>
                            </div>
                        ...
                        <div className="col-lg-8">
                            <div className="service-details">
                                <div className="service-details-image mb_60"><img src="assets/images/resource/service-11.jpg" alt=""/></div>
                                <h2 className="service-details-title mb_20">Memory Care</h2>

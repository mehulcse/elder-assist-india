                    ...
                    <div className="row">
                        <div className="col-lg-4 pe-lg-60">
                            <div className="category-widget">
                                ...
                                <ul className="category-widget-list">
                                    ...
                                    <li className="active"><Link href="/nursing-care">Nursing Care <i className="icon-40"></i></Link></li>
                        ...
                        <div className="col-lg-8">
                            <div className="service-details">
                                <div className="service-details-image mb_60"><img src="assets/images/resource/service-12.jpg" alt=""/></div>
                                <h2 className="service-details-title mb_20">Nursing Care</h2>

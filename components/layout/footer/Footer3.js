                            ...
                            <div className="col-lg-4">
                                <div className="footer-widget twitter-widget">
                                    ...
                                    <div className="widget-content">
                                        ...
                                        <div className="text"><Link href="#">#Consultancy</Link> UK rank <Link href="#">#Lovegiver</Link> as the 1st best management consultancy overall certified companies.</div>
                ...
                <div className="footer-bottom-three">
                    <div className="auto-container">
                        <div className="row m-0 justify-content-between">
                            <div className="copyright-text"><Link href="#">© {new Date().getFullYear()} Lovegiver,</Link> All Rights Reserved.</div>
                            <ul className="menu">

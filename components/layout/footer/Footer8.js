                                ...
                                <div className="single-footer-widget marbtm">
                                    <div className="our-company-info">
                                        <div className="footer-logo">
                                            <Link href="/index"><img src="assets/images-3/footer-logo-8.png" alt="Awesome Footer Logo" title="Logo" /></Link>
                                        </div>
                    ...
                    <div className="container">
                        <div className="outer-box">
                            <div className="copyright-text">
                                <p>Copyrights © 2021 <Link href="#">Lovegiver </Link>, All Rights Reserved.</p>
                            </div>

            ...
            <footer className="footer-style-15">
                                    ...
                                    <div className="widget-content">
                                        ...
                                        <div className="inner">
                                            ...
                                            <div className="email">
                                                ...
                                                <p><Link href="/mailto:support@lovegiver.com">support@lovegiver.com</Link><br />Mon-Satday: 9am to 6.pm</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <div className="footer-bottom">
                    <div className="auto-container clearfix">
                        <div className="copyright"><p>Copyrights © 2021 <Link href="/index-15">Lovegiver</Link>, All Rights Reserved.</p></div>

                            ...
                            <div className="col-lg-4">
                                <div className="footer-widget about-widget-two">
                                    <div className="footer-logo">
                                        <Link href="/index"><img className="lazy-image" src="assets/images/resource/image-spacer-for-validation.png" data-src="assets/images/logo-v4-2.png" alt="" /></Link>
                                    </div>
                                    <div className="widget-content">
                                        ...
                                        <div className="copyright-text">© {new Date().getFullYear()} Lovegiver consultancy.</div>
                                    </div>
                                </div>
                            </div>
                            <div className="col-lg-4">

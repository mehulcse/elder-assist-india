                                ...
                                <div className="footer-widget contact-widget">
                                    ...
                                    <div className="widget-content">
                                        ...
                                        <ul className="list">
                                            ...
                                            <li>Mail us :  <Link href="/mailto:supportteam@Lovegiver.com">Supportteam@Lovegiver.com</Link></li>
                                        </ul>
                ...
                <div className="footer-bottom-two">
                    <div className="auto-container">
                        <div className="row m-0 justify-content-between">
                            <div className="copyright-text">© {new Date().getFullYear()} Lovegiver, All Rights Reserved.</div>
                            <ul className="menu">

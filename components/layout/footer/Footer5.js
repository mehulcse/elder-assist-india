                                        ...
                                        <div className="footer-widget logo-widget">
                                            <div className="widget-content">
                                                <div className="footer-logo">
                                                    <Link href="/index"><img className="lazy-image" src="assets/images/resource/image-spacer-for-validation.png" data-src="assets/images/logo-v5-2.png" alt="" /></Link>
                                                </div>
                ...
                <div className="footer-bottom">
                    <div className="auto-container">
                        <div className="row m-0 justify-content-between">
                            <div className="copyright"><Link href="#">© {new Date().getFullYear()} Lovegiver</Link> Consultancy, All Rights Reserved.</div>
                            <ul className="menu">

...
export default function Fundraise() {
    return (
        <>
            <section className="fundraise-1-section">
                    ...
                    <div className="row">
                        <div className="col-lg-4 col-md-6">
                            <div className="fundraise-1-block wow fadeInLeft" data-wow-delay=".2s" data-wow-duration=".8s">
                                ...
                                <div className="fundraise-1-content">
                                        ...
                                        <div className="fundraise-1-skill-bar">
                                            <div className="progressbar-1-outer">
                                                <div className="progressbar-1-inner progress-line" >
                                                    <div className="progressbar-1-percentage"><div className="count-box"><span className="count-text">85</span>%</div></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>

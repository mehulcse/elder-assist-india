                    ...
                    <div className="row">
                        <div className="col-lg-4 col-md-6">
                            <div className="blog-1-block wow fadeInLeft" data-wow-delay=".2s" data-wow-duration=".8s">
                                ...
                                <div className="blog-1-bottom-content alt2">
                                    <div className="blog-1-date alt"><span>15 </span><br /> APRIL</div>
                                    ...
                                    <p className="blog-1-excerpt">Tincidunt Maur nemi sit Inter praesent
                                        morbi lacinia volutpat.</p>
                                </div>
                            </div>
                        </div>
                        <div className="col-lg-4 col-md-6">

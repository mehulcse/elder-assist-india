                                ...
                                <div className="team-2-image">                              
                                    ...
                                    <div className="team-2-share-icon-area">
                                        <ul className="team-2-social-icon">
                                            <li><Link href="/index-4"><i className="fab fa-facebook-f"></i></Link></li>
                                            <li><Link href="/index-4"><i className="fab fa-twitter"></i></Link></li>
                                            <li><Link href="/index-4"><i className="fab fa-instagram"></i></Link></li>
                                        </ul>
